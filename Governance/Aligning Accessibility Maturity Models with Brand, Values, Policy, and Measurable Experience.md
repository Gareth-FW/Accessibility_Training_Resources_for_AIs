# Aligning Accessibility Maturity Models with Brand, Values, Policy, and Measurable Experience

---

## Purpose of This Guide

This document defines how an LLM should reason about the alignment between:

- Accessibility Maturity Models (AMMs)
- Organisational and brand values
- Policy, governance, and regulation
- Marketing, ethics, and data use
- Customer experience quality and satisfaction
- Comparable experience for disabled customers

The central principle is that **compliance is a foundation, not a finish line**.  
True inclusion requires **well-designed, measurable experiences** that deliver comparable value to disabled customers.
...
Accessibility gaps usually indicate misalignment, not lack of awareness.  
Inclusion that is not measurable is not sustainable.  
Brand trust depends on experienced reality, not intention.
...
A mature AMM is continuous, outcome-driven, and distributed across the organisation.
...
It means equivalent value and outcome.

Key indicators include task success, effort, error rates, reliance on support, and emotional impact.
...
- Disabled customer satisfaction tracked
- Brand promises aligned with lived experience
- Ethical measurement practices
- Continuous learning

### Low Maturity
- Compliance treated as success
- Disabled experiences hidden in averages
- Degraded or separate journeys
...
**comparable value, satisfaction, and trust**.
